      ...
      <div className="mx-auto max-w-[1400px] px-6 sm:px-8 lg:px-12">
        <div className="flex h-20 items-center justify-between">
          ...
          <nav className="hidden items-center gap-10 md:flex">
            ...
            <Link
              href="/contato"
              className="inline-flex items-center justify-center bg-[#0A43D8] text-white font-semibold text-sm py-2.5 px-6 rounded-lg shadow-md hover:bg-[#042A8F] hover:shadow-lg transition-all duration-200"
            >
              Contacto
            </Link>
            <div className="flex items-center gap-2 ml-4 pl-4 border-l border-gray-200">
              <a
                ...
                className="text-gray-500 hover:text-[#0A43D8] transition-colors"
        ...
        {isOpen && (
          <nav className="border-t border-gray-200 py-6 md:hidden">
            <div className="flex flex-col gap-5">
              ...
              <div className="flex items-center gap-4 pl-4 mt-4 pt-4 border-t border-gray-200">
                <a
                  href="https://www.instagram.com/okukalaimobiliaria?igsh=MW40d2djMzZ4dXlkMA=="
                  target="_blank"
                  rel="noopener noreferrer"
